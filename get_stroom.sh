...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v6.1.9/stroom-stacks-v6.0-beta.28-9/; s/v6.1.9/v6.0-beta.28-9/; s/9ecefff93f8f64e82e338475e51932b6446282ef846c52080dd34d3453b3468d  stroom_core_test-v6.1.9.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v6.1.9"
  local -r stack_version="v6.1.9"
  local -r hash_file_contents="9ecefff93f8f64e82e338475e51932b6446282ef846c52080dd34d3453b3468d  stroom_core_test-v6.1.9.tar.gz"
